                        ...
                        <div class="form-line">
                            <select name="category_id" id="category_id" class="form-control show-tick" data-container="body" required>
                                ...
                                @foreach($categories as $category)
                                    <option value="{{ $category->id }}" {{ $barang->category_id == $category->id ? 'selected' : '' }}>{{ $category->nama_kategori }}</option>
                                @endforeach
                            </select>
                        </div>
                    </div>
                            ...
                            <div class="form-group">
                                <div class="form-line">
                                    <select name="rak_id" id="rak_id" class="form-control show-tick" data-container="body">
                                        ...
                                        @foreach($raks as $rak)
                                            <option value="{{ $rak->id }}" {{ $barang->rak_id == $rak->id ? 'selected' : '' }}>{{ $rak->nama_lokasi }} - {{ $rak->nama_rak }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
